...
test = {   'name': 'q2b',
    ...
    'suites': [   {   'cases': [   {'code': '>>> elementwise_array_sum([], [])\narray([], dtype=float64)', 'hidden': False, 'locked': False},
                                   {'code': '>>> elementwise_array_sum([1], [1])\narray([2], dtype=int32)', 'hidden': False, 'locked': False},
                                   {'code': '>>> elementwise_array_sum([-1], [1])\narray([2], dtype=int32)', 'hidden': False, 'locked': False},
                                   {'code': '>>> elementwise_array_sum([1], [-1])\narray([0], dtype=int32)', 'hidden': False, 'locked': False},
                                   {'code': '>>> elementwise_array_sum([1, 2, 3], [1, 2, 3])\narray([ 2, 12, 36], dtype=int32)', 'hidden': False, 'locked': False},
                                   {'code': '>>> elementwise_array_sum([1, 5, 2], [3, 6, 6])\narray([ 28, 241, 220], dtype=int32)', 'hidden': False, 'locked': False},
